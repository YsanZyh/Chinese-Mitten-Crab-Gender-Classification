...
from CrabPredict.nets.densenet import _Transition, densenet121, densenet169, densenet201
from CrabPredict.nets.ghostnet import ghostnet
from CrabPredict.nets.mobilenet_v1 import mobilenet_v1
from CrabPredict.nets.mobilenet_v2 import mobilenet_v2
from CrabPredict.nets.mobilenet_v3 import mobilenet_v3
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, backbone="mobilenetv2", pretrained=False):
        ...
        if backbone == "mobilenetv1":
            ...
            raise ValueError(
                'Unsupported backbone - `{}`, Use mobilenetv1, mobilenetv2, mobilenetv3, ghostnet, '
                'densenet121, densenet169, densenet201.'.format(backbone))
